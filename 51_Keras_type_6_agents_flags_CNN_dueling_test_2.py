...
def main():
    ...
    if load_model:
        for idx in range(n_agents):
            agents[idx].model.load_weights(model_path + "/Model_dueling_6agt_2_{}.h5".format(idx))
    ...
    for idx in range(n_agents):
        agents[idx].model.save_weights(model_path + "/Model_dueling_6agt_2_{}.h5".format(idx))
